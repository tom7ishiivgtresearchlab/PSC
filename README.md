...
*Note: In this repository, the Planck Sphere is treated mathematically as a sphere since 4π (the solid angle of a sphere) appears in the core equation. However, whether the initial state and the present universe are truly spherical remains observationally unconfirmed. For details, see the notes in the development document and Axioms 3a and 3b in the formulation document.*

---

## Title

**Planck Sphere Cosmology: The Minimal Unit of the Universe and Its Unified Description of Fundamental Physics**
...
| Baryon asymmetry η | ≈ 6.1 × 10⁻¹⁰ (within 1.7% of observed) | Proposed |
| Cosmological constant | Λ(t) ~ 1/R(t)² | Proposed |
| Universe geometry | Spherical surface confirmed mathematically (4π); physical form unconfirmed | Proposed |
...
Planck sphere, quantum gravity, unified field theory, baryon asymmetry, cosmological constant, dark energy, dark matter, Origin Field Theory, Virtual Gravity Theory, Planck length, information theory, Dirac structure, cyclic universe
...
| File | Content |
|------|---------|
| `planck_sphere_overview_20260616.md` | Conceptual introduction and general guide |
| `planck_sphere_development_20260616.md` | Development of ideas (12 stages) |
| `planck_sphere_equations_20260616.md` | Complete equation overview and cosmological scenarios |
| `planck_sphere_formulation_20260616.md` | Mathematical formalization: axioms, theorems, propositions |

Japanese versions of all documents are available with the suffix `_ja` in the filename.

---

## Relation to VGT and OFT
...
PSC is positioned as a new perspective that supports the theoretical foundation of VGT and OFT from the minimal geometric unit of the Planck Sphere.
...
Ishii, T. (2026). *Planck Sphere Cosmology: The Minimal Unit of the Universe and Its Unified Description of Fundamental Physics*. GitHub: PSC Repository. Zenodo. DOI: 10.5281/zenodo.20736648
